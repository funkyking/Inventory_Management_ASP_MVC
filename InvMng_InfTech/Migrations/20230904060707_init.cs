    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartID = table.Column<Guid>(name: "Part ID", type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryMaster", x => x.PartID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserThatAdded = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationID = table.Column<Guid>(name: "Location ID", type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Representative = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplyMaster", x => x.ID);
                });
